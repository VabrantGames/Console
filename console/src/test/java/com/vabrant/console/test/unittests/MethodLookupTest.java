...
public class MethodLookupTest {
	...
	void addTest() {
		...
		executePrivateMethod(lookup, "addReferenceMethod", new Class[]{Method.class},
				getMethod(TestClass.class, "hello"));
		executePrivateMethod(lookup, "addReferenceMethod", new Class[]{Method.class},
				getMethod(TestClass.class, "hello", int.class));
		executePrivateMethod(lookup, "addReferenceMethod", new Class[]{Method.class},
				getMethod(TestClass.class, "hello", String.class, int.class, double.class, char.class));

		assertNotNull(executePrivateMethod(lookup, "getReferenceMethod",
				new Class[]{Class.class, String.class, Class[].class}, TestClass.class, "hello", null));
		assertNotNull(executePrivateMethod(lookup, "getReferenceMethod",
				new Class[]{Class.class, String.class, Class[].class}, TestClass.class, "hello",
				new Class[]{int.class}));
		assertNotNull(executePrivateMethod(lookup, "getReferenceMethod",
				new Class[]{Class.class, String.class, Class[].class}, TestClass.class, "hello",
				new Class[]{String.class, int.class, double.class, char.class}));
	}
