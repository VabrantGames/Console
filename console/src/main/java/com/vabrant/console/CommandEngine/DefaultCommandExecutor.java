 ...
 * The default CommandEngine that splits commands by spaces.
 *
 * Command format:
 * 	command arg1 arg2...
 * 	reference.command arg1 arg2...
 *
 */
public class DefaultCommandExecutor extends AbstractCommandExecutor<CommandCache> {
	...
	@Override
	public CommandExecutorExecutionResult execute (CommandCache cache, Object o) {
...
//		String commandAsString = null;
	...
	private void executeZeroArgumentStringCommand (CommandCache cache, String cmd) throws Exception {
		if (cmd.contains(".")) {
			...
			if (command == null) command = cache.getCommand(null, cmd, null);
		}
