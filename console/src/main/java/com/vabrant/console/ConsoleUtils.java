	...
	public static boolean areArgsEqual(Class[] args, Class[] userArgs) {
		...
		for(int i = 0; i < args.length; i++) {
			...
			if(c1.equals(int.class)) {
				if (c2.equals(Integer.class)) continue;
				return false;
			}
			...
			if (c1.equals(double.class)) {
				if (c2.equals(Double.class) || c2.equals(Float.class) || c2.equals(Integer.class) ||
...
//			if(c1.equals(long.class) && c2.equals(Integer.class)) continue;
